        ...
        <div className="p-8">
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500 mt-2">First-time users: Use your student ID as password</p>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold px-6 py-3 rounded-lg shadow-md transition-all duration-300 hover:shadow-lg disabled:opacity-75 disabled:cursor-not-allowed flex items-center justify-center"
            >
              {loading ? (
                <>
